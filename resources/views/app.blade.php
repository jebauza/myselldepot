...
<head>
    ...
    <title>{{ config('app.name', 'Myselldepot') }}</title>
...
<body class="sidebar-mini text-sm" style="height: auto;">
    <div class="wrapper">
        ...
        <aside class="control-sidebar control-sidebar-dark" style="display: none;">
            ...
            <div class="p-3 control-sidebar-content">
                ...
                <div class="mb-1"><input type="checkbox" value="1" class="mr-1"><span>Sidebar nav legacy style</span>
                </div>
                <div class="mb-1"><input type="checkbox" value="1" class="mr-1"><span>Sidebar nav compact</span></div>
                <div class="mb-1"><input type="checkbox" value="1" class="mr-1"><span>Sidebar nav child indent</span>
                </div>
                <div class="mb-1"><input type="checkbox" value="1" class="mr-1"><span>Main Sidebar disable hover/focus
    ...
    <div class="ff-ext--bootstrapResponsiveHelper">
        <div class="visible-lg-block" attr-tag="lg" attr-version="3"></div>
        <div class="visible-md-block" attr-tag="md" attr-version="3"></div>
        <div class="visible-sm-block" attr-tag="sm" attr-version="3"></div>
        <div class="visible-xs-block" attr-tag="xs" attr-version="3"></div>
        <div class="d-none d-xl-block" attr-tag="xl" attr-version="4"></div>
        <div class="d-none d-lg-block" attr-tag="lg" attr-version="4"></div>
        <div class="d-none d-md-block" attr-tag="md" attr-version="4"></div>
        <div class="d-none d-sm-block" attr-tag="sm" attr-version="4"></div>
        <div class="d-none d-block" attr-tag="xs" attr-version="4"></div>
    </div>
